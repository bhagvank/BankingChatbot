...
class Parse():
    ...
    def __init__(self,filename, verbose=False):
        ...
        self.inputString, info['extension'] = self.readFile("files/"+filename) 
    ...
    def getName(self, inputString, infoDict, debug=False):
        ...
        indianNames = open("files/allNames.txt", "r").read().lower()
    ...
    def getQualification(self,inputString,infoDict,D1,D2):
        ...
        nameofinstitutes=open('files/nameofinstitutes.txt','r').read().lower()#open file which contains keywords like institutes,university usually  fond in institute names
